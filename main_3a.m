...
d_H_icml        = zeros(1,length(r_));
d_H_rlus        = zeros(1,length(r_));
d_H_admm        = zeros(1,length(r_));
...
plot(r_,d_H_admm,styles(3),'DisplayName','Biconvex','MarkerSize',11,'Linewidth',1.25);
plot(r_,d_H_levsort,styles(5),...
    'DisplayName','Levsort',...
    'MarkerSize',11,'Linewidth',1.25);
plot(r_,d_H_icml,styles(6),...
